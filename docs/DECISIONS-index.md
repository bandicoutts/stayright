...
| DECISION-077 | Reskin Phase 3 — Trips list recompose + List/Timeline toggle | List with conditional badges (abroad/planned/Crown), neutral Crown chip "doesn't count", peak-window span, single header stat, NEW Gantt timeline; bulk-delete/sort/window-at-departure dropped | Decided |
