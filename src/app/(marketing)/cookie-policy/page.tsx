    ...
    <>
      ...
      <main id="main-content" className="bg-[#F8F9FA] pt-28 pb-20 px-6 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-sm text-[#3D4A42]/70 mb-10">Last Updated: [Date]</p>
          ...
          <div className="font-[family-name:var(--font-inter)] text-base text-[#3D4A42] leading-relaxed space-y-6">
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">1. What Are Cookies?</h2>
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">2. How We Use Cookies</h2>

            <h3 className="text-lg font-semibold text-[#191C1D] mt-8 mb-3 font-[family-name:var(--font-manrope)]">2.1 Essential Cookies (Strictly Necessary)</h3>
            ...
            <h3 className="text-lg font-semibold text-[#191C1D] mt-8 mb-3 font-[family-name:var(--font-manrope)]">2.2 Analytics Cookies</h3>
            ...
            <h3 className="text-lg font-semibold text-[#191C1D] mt-8 mb-3 font-[family-name:var(--font-manrope)]">2.3 Third-Party Cookies</h3>
            <p>When you purchase a Pro subscription, payments are processed by <strong>Stripe</strong>. Stripe may set cookies on your device to facilitate a secure transaction and to detect fraud. These are managed securely by Stripe according to their own privacy policies. For more details, visit: <a href="https://stripe.com/cookies-policy/legal" target="_blank" rel="noopener noreferrer" className="text-[#006948] hover:underline">Stripe Cookie Policy</a></p>

            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">3. How to Manage Your Cookies</h2>
