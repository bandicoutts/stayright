      ...
      <main id="main-content" className="bg-[var(--color-bg)] pt-28 pb-20 px-6 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="font-[family-name:var(--font-body)] text-base text-[var(--color-text-2)] leading-relaxed space-y-6">
            ...
            <h2 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-[var(--color-text-primary)] mt-10 mb-4">1. What Are Cookies?</h2>
            ...
            <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mt-8 mb-3 font-[family-name:var(--font-heading)]">2.1 Essential Cookies (Strictly Necessary)</h3>
            ...
            <h2 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-[var(--color-text-primary)] mt-10 mb-4">3. How to Manage Your Cookies</h2>
