    ...
    <>
      ...
      <main id="main-content" className="bg-[var(--color-bg)] pt-28 pb-20 px-6 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-body)] text-sm text-[var(--color-text-muted)] mb-10">Last Updated: [Date]</p>
          ...
          <div className="font-[family-name:var(--font-body)] text-base text-[var(--color-text-2)] leading-relaxed space-y-6">
            ...
            <h2 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-[var(--color-text-primary)] mt-10 mb-4">1. What cookies are</h2>
            ...
            <h2 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-[var(--color-text-primary)] mt-10 mb-4">2. How we use cookies</h2>

            <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mt-8 mb-3 font-[family-name:var(--font-heading)]">2.1 Essential cookies</h3>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Supabase authentication cookies:</strong> Used to manage your session securely when you log into the platform. They keep you signed in as you use the app.</li>
              <li><strong>Cookie preference:</strong> <code>cookie_consent</code> is used to remember whether you have accepted or declined non-essential cookies.</li>
            </ul>

            <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mt-8 mb-3 font-[family-name:var(--font-heading)]">2.2 Analytics cookies</h3>
            ...
            <h3 className="text-lg font-semibold text-[var(--color-text-primary)] mt-8 mb-3 font-[family-name:var(--font-heading)]">2.3 Third-party cookies</h3>
            ...
            <h2 className="font-[family-name:var(--font-heading)] font-bold text-2xl text-[var(--color-text-primary)] mt-10 mb-4">3. How to manage cookies</h2>
