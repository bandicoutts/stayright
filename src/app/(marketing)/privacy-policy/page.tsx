    ...
    <>
      ...
      <main id="main-content" className="bg-[#F8F9FA] pt-28 pb-20 px-6 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-sm text-[#3D4A42]/70 mb-10">Effective Date: [Date] [LEGAL REVIEW REQUIRED: Confirm effective date before publishing]</p>

          <div className="font-[family-name:var(--font-inter)] text-base text-[#3D4A42] leading-relaxed space-y-6">
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">1. Who We Are</h2>
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">2. What Personal Data We Collect and Why (Lawful Basis)</h2>
            ...
            <ul className="list-disc pl-5 space-y-3">
              <li>
                ...
                <br/><span className="text-[#3D4A42]/70 text-sm">Lawful Basis: Performance of a contract.</span>
              </li>
              <li>
                ...
                <br/><span className="text-[#3D4A42]/70 text-sm">Lawful Basis: Performance of a contract (core product functionality).</span>
              </li>
              <li>
                ...
                <br/><span className="text-[#3D4A42]/70 text-sm">Lawful Basis: Performance of a contract and compliance with a legal obligation (tax and accounting).</span>
              </li>
              <li>
                ...
                <br/><span className="text-[#3D4A42]/70 text-sm">Lawful Basis: Legitimate interests (or Consent where cookies are involved).</span>
              </li>
            </ul>
            <p className="text-sm text-[#006948] bg-[#006948]/10 p-4 rounded-xl border border-[#006948]/20">
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">3. Data Retention Policy</h2>
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">4. Data Processors (Who We Share Your Data With)</h2>
            <p>We use trusted third-party service providers ("Data Processors") to run StayRight. We have Data Processing Agreements (DPAs) in place with them to protect your data.</p>
            <ul className="list-disc pl-5 space-y-2">
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">5. Your Rights Under UK GDPR</h2>
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">6. How to Exercise Your Rights</h2>
            ...
            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">7. How to Complain to the ICO</h2>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li><strong>Website:</strong> <a href="https://ico.org.uk/make-a-complaint/" className="text-[#006948] hover:underline">https://ico.org.uk/make-a-complaint/</a></li>
              <li><strong>Helpline:</strong> 0303 123 1113</li>
            </ul>

            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">8. Cookies</h2>
            <p>We use cookies to keep you logged in and to remember your preferences. Please review our <a href="/cookie-policy" className="text-[#006948] hover:underline">Cookie Policy</a> for details.</p>

            <h2 className="font-[family-name:var(--font-manrope)] font-bold text-2xl text-[#191C1D] mt-10 mb-4">9. Changes to this Policy</h2>
